...
# GÖREV 2: RFM Metriklerinin Hesaplanması
    ...
    # 1. Recency, Frequency, Monetary tanımlarını yapınız
    # Recency = Müşterinin son alışverişinden bugüne kadar geçen gün sayısıdır.
    # Frequency = Müşterinin toplam alışveriş sayısıdır.
    # Monetary = Müşterinin toplam harcamasıdır.
...
# GÖREV 5: Aksiyon zamanı!
           ...
           # 2. RFM analizi yardımı ile 2 case için ilgili profildeki müşterileri bulun ve müşteri id'lerini csv ye kaydediniz.
                   ...
                   # yeni_marka_hedef_müşteri_id.cvs olarak kaydediniz.
                    ...
                    # rfm'in indexini "master_id" olarak atıyoruz:
